...
useEffect(() => {
          ...
          <div className='flex flex-col m-5 border-solid border-2 border-slate-500 w-10/12 rounded-md p-2' key={i}>
              <div>
                <div className='flex justify-between'>
                  ...
                  <button className='flex justify-right bg-tertiary-500 w-6 p-3 rounded-lg text-green-600 -mt-1 cursor-pointer'
            ...
            <div className='flex justify-between'>
              ...
              <div>
                  ...
                  <svg class = "bi bi-hand-thumbs-up-fill fill-white stroke-violet-800 stroke-1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
    ...
    return (
        <div className='flex flex-col items-center justify-center h-screen w-screen'>
            ...
            <div className='w-11/12 flex flex-col items-center shadow-lg overflow-y-auto h-50'>
              {allQuestions}
            </div>
        </div>
    )
